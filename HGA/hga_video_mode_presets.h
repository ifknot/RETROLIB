...
*/
const uint8_t hga_text_config_default = 0; // 0b00000000;
...
*/
const uint8_t hga_text_ctrl_default = 0; // 0b00000000;
...
*/
const uint8_t hga_graphics_config_default = 3; //00000011b; // enable graphics "full" mode with 2 frame buffers
...
* bit 7 = 0 display page 1
*/
const uint8_t hga_graphics_ctrl_default = 2; // 00000010b; // enter graphics mode display page 1

/**
* CRTC 6845 processor 16 preset reg:data value pairs for *text* mode
* @note values as per Hercules recommended
*/
const uint8_t hga_crtc_presets_text_mode[32] = {
    // reg  value   meaning
...
* @note values as per Hercules recommended
*/
const uint8_t hga_crtc_presets_graphics_mode[32] = {
    // reg  value   meaning
